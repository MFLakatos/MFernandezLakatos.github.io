...
class MediaOrganizer:
    def __init__(self,
                 ...
                 ffmpeg_path: str,
                 ffprobe_path: str,
                 env_file: str = 'environmentVar.env',
                 log_file: str = 'processed_files.txt',
                 max_files_per_session: int = 2499) -> None:
        """
        ...
        self.processed_log_path = log_file
    ...
    def _load_processed_files(self) -> set:
        """Carga los nombres de archivos ya procesados desde el log."""
    ...
    def rename_and_copy_media(self) -> None:
        ...
        for filename in os.listdir(self.input_dir):
            ...
            if processed_count >= self.max_files_per_session:
                print(f"Límite de {self.max_files_per_session} archivos alcanzado. Deteniendo.")
                break
