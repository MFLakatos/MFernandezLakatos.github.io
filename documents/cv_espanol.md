...
- Docencia en **física universitaria** en el Instituto de Física; desarrollo y entrega de materiales de curso para estudiantes de grado.
- Investigación en múltiples proyectos: propiedades de largo alcance de la interacción nuclear fuerte (QCD), instrumentos multiespectrales para monitoreo remoto de gases, recuperación de objetos de fase y creación de nuevos métodos de integración a partir de una sola derivada.
- Publicación de **4 artículos de primer autor revisados por pares** en revistas indexadas en Scopus y 2 artículos como coautor.
- Presentación de investigaciones en **congresos internacionales** (SPIE, IOP, Elsevier), fortaleciendo habilidades de comunicación técnica.
...
|---|---|---|
| 🏆 [Neo4j Certified Professional](https://graphacademy.neo4j.com/c/1762f6b4-ab16-409f-a33a-22495f92ee05/) | Neo4j GraphAcademy | Mayo 2026 |
| 🐍 Master Python para DevOps y CI/CD | Udemy | 2025 |
| 🌐 [Uso de Neo4j con Python](https://graphacademy.neo4j.com/c/12d268df-59fb-491f-a0c8-f456bcea6f74/) | Neo4j GraphAcademy | Mayo 2026 |
| 📊 [Consultas Cypher Intermedias](https://graphacademy.neo4j.com/c/d4fc952e-6121-40e1-a595-4f44072e02ca/) | Neo4j GraphAcademy | Mayo 2026 |
| 🗃️ [Fundamentos de Importación de Datos](https://graphacademy.neo4j.com/c/519c30c6-a901-4372-8cde-891b37b4739e/) | Neo4j GraphAcademy | Mayo 2026 |
| 🧩 [Fundamentos de Modelado de Datos de Grafos](https://graphacademy.neo4j.com/c/1f7508e8-995f-4354-9e1e-10fa78f787b5/) | Neo4j GraphAcademy | Mayo 2026 |
| 🔤 [Fundamentos de Cypher](https://graphacademy.neo4j.com/c/45dbc383-1c6f-4e68-aeb9-0a5a510e85ad/) | Neo4j GraphAcademy | Abr 2026 |
| 🏗️ [Fundamentos de Neo4j](https://graphacademy.neo4j.com/c/ba7fc5aa-19b0-4be4-b709-455e9c7b338c/) | Neo4j GraphAcademy | Abr 2026 |

🔗 Perfil completo Neo4j: [graphacademy.neo4j.com/u/34d98b08-78b3-4f35-a97c-3c869a7dec4e](https://graphacademy.neo4j.com/u/34d98b08-78b3-4f35-a97c-3c869a7dec4e/)
...
### Artículos de Primer Autor (Revisados por Pares, Indexados en Scopus)

1. **[2024 – SPIE]** [Integration with one partial derivative applied to quantitative phase imaging](https://www.spiedigitallibrary.org/conference-proceedings-of-spie/12852/3000403/Integration-with-one-partial-derivative-applied-to-quantitative-phase-imaging/10.1117/12.3000403.short)
2. **[2023 – Optics and Lasers in Engineering, Scopus]** [Common-path quantitative phase imaging by propagation through a sinusoidal intensity mask](https://www.sciencedirect.com/science/article/abs/pii/S0143816623003342)
3. **[2022 – Optik, Scopus]** [Phase retrieval by amplifying the prism term of the Transport of Intensity Equation with a sliding step function](https://www.sciencedirect.com/science/article/pii/S003040262201378X)
4. **[2019 – IJMPA, Scopus]** [On the contribution of different coupling constants in the infrared regime of Yang–Mills theory](https://www.worldscientific.com/doi/abs/10.1142/S0217751X19502142)

### Artículos como Coautor

5. **[2025 – Optics & Laser Technology]** [Wavefront reconstruction of discontinuous phase objects using directional derivatives](https://www.sciencedirect.com/science/article/abs/pii/S0030399224015111)
6. **[2024 – IOP Science / Measurement Science and Technology]** [Hilbert's and Takeda's single-shot interferometry with a linear-carrier: a comparison](https://iopscience.iop.org/article/10.1088/1361-6501/ad2254)

---

## LOGROS Y BECAS

- **Miembro del Sistema Nacional de Investigadores (SNI)**, Uruguay, 2024
- **Beca de doctorado**, Comisión Académica de Posgrados (CAP), 2022
- **Beca de doctorado**, Agencia Nacional de Investigación e Innovación (ANII), 2019
- **Beca de maestría**, Comisión Académica de Posgrados (CAP), 2016
...
*"Viaje antes que destino"* — una mentalidad de aprendizaje continuo, exploración creativa y disfrute del proceso tanto como del resultado.
