...
I'm a **Research Engineer at Gradiant** (Vigo, Spain) specializing in **artificial intelligence and data analytics**. My work focuses on developing intelligent solutions for early threat detection in corporate cybersecurity using:
...
- **Cybersecurity AI**: Developing ML models for threat detection
- **Explainable AI**: Making AI decisions interpretable and transparent
- **Big Data Analytics**: Processing large-scale datasets efficiently
...
- 💼 **Current Role**: Research Engineer at Gradiant
